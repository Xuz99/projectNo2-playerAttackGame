		...
		switch (msg.$) {
			...
			case 'ChangePage':
				...
				if (_v1.$ === 'Game') {
					...
					return _Utils_update(
						model,
						{enemy: $author$project$Main$initEnemy, enemyDeaths: $author$project$Main$initEnemyDeaths, page: page, player: $author$project$Main$initPlayer});
				}
			default:
				var respawnEnemy = {attackPower: 1, hP: 4};
				var oldPlayer = model.player;
				var oldEnemy = model.enemy;
				var newHpFromEnemy = model.enemy.hP - model.player.attackPower;
				var newPlayer = (newHpFromEnemy > 0) ? _Utils_update(
					oldPlayer,
					{hP: model.player.hP - model.enemy.attackPower}) : oldPlayer;
				var newEnemyDeaths = (newHpFromEnemy <= 0) ? (model.enemyDeaths + 1) : model.enemyDeaths;
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Main$AttackEnemy = {$: 'AttackEnemy'};
...
var $author$project$Main$viewGame = function (model) {
	var _v0 = model.page;
	if (_v0.$ === 'Game') {
		var playerDeath = model.player.hP <= 0;
		var enemyDeath = model.enemy.hP <= 0;
		return playerDeath ? A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('Enemy wins!'),
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('Player wins!'),
							$mdgriffith$elm_ui$Element$text(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$padding(300),
							$mdgriffith$elm_ui$Element$Background$color(
							A4($mdgriffith$elm_ui$Element$rgba255, 211, 74, 40, 0.9)),
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('YOU WON!'),
							A2(
							$mdgriffith$elm_ui$Element$image,
							_List_Nil,
							{description: 'A firework gif', src: 'https://media.giphy.com/media/iJc8fraqaofWo/giphy.gif'}),
							A2(
							$mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
								[
								...
								]),
							{
								...
								onPress: $elm$core$Maybe$Just(
									$author$project$Main$ChangePage($author$project$Main$Game))
							})
						]))
				]));
	}
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"ChangePage":["Main.Page"],"AttackEnemy":[]}},"Main.Page":{"args":[],"tags":{"Game":[],"Win":[]}}}}})}});}(this));